...
Test data is available for the low-resolution visualization on Synapse in the folder Exemplary_VisualizationDataset.
LINK

The data in the folder is structured as:
...
Test data is available for the high-resolution visualization on Synapse in the folder Exemplary_VisualizationDataset.
LINK
