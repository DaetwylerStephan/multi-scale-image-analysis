...
class image_visualizer():
    """
       This class generates visualizations of low-resolution rawdata of zebrafish xenograft.
       """
    ...
    def load_images(self, vis_param):
        ...
        for i_time in timepointlist:
            ...
            image_magenta = skimage.transform.resize(image_magentabig, output_shape=(210, 228, 920), order=0)
            image_cyan = skimage.transform.resize(image_cyanbig, output_shape=(210, 228, 920), order=0)
...
if __name__ == '__main__':
    ...
    visualization_param = dict(
        camera_angle1=(11.795533280843951, -23.146405413326022, -108.6356067503055),
        camera_angle2=(11.210723166577056, -26.636881955243513, -107.07225928320236),
        camera_zoom=0.701,
        raw_contrast_limits_magenta=(240, 4000),
        raw_contrast_limits_cyan=(340, 2023),
        raw_gamma_magenta=0.78,
        raw_gamma_cyan=0.72,
        magenta_colormap ='cyan',
        cyan_colormap='magenta',
        opacity_cyan=0.64,
    ...
    imagevisu.rawdatafolder = "/archive/bioinformatics/Danuser_lab/Fiolka/LabMembers/Stephan/multiscale_data/xenograft_experiments/MDA-MB-231/20230720_control/Experiment0010_stitched/fish2"
    experimentfolder_result = imagevisu.rawdatafolder + "_lowres_visualized"
