...
def generate_binaryimage(im_deconvolved):
    ...
    im_ = np.clip(im_, 0, 4)
    binary_thresh = skfilters.threshold_otsu(im_)  # what the best threshold?
...
if __name__ == "__main__":
    ...
    try:
        from SegmentationHighres.preprocessing_class import ImagePreprocessing as im_preprocess
    except:
    ...
    for i_time in timepointlist:
        ...
        try:
            import multiScaleAnalysis.SegmentationHighres.gradient_watershed.filters as grad_filters
            import multiScaleAnalysis.SegmentationHighres.gradient_watershed.watershed as grad_watershed
            import multiScaleAnalysis.SegmentationHighres.gradient_watershed.flows as grad_flows
